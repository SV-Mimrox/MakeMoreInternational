...
{
    public class ProductMenuMobileViewComponent : ViewComponent
    {
        private readonly CategoryService _categoryService;
        private readonly ProductService _productService;

        public ProductMenuMobileViewComponent(CategoryService categoryService, ProductService productService)
        {
